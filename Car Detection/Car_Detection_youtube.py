...
youtube_url = "https://youtu.be/PNDIu98zvL4"
...
def process(frame, lane_image):
    ...
    x1_list = [200,500,770,920]
    x2_list = [435,615,885,1035]
    y1_list = [300,620,620,620]
    y2_list = [500,700,700,700]
